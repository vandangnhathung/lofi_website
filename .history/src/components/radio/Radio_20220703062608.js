    ...
    <label className="absolute cursor-pointer w-[200px] h-[72px] group flex justify-center">
      ...
      <div
        className={`absolute top-[50%] hidden ${
          dayRain ? "p-2" : "px-[3.24rem] py-[3.25rem]"
        }  text-white capitalize rounded-lg group-hover:animate-scale group-hover:block group-active:block bg-blackBackground whitespace-nowrap hover:text-opacity-30 transition-all duration-200 text-center`}
      >
