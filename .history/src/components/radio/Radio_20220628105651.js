  ...
  return (
    <label className="absolute cursor-pointer w-[200px] h-[72px] group flex justify-center">
      ...
      <div className="absolute border-[3px] border-white rounded-full w-8 h-8 group-hover:border-primary">
        ...
        <p className="absolute top-[110%] capitalize group-hover:animate-scale hidden group-hover:block p-3 text-white bg-blackBackground whitespace-nowrap rounded-lg px-6">
          {text}{" "}
        </p>
      </div>
    </label>
