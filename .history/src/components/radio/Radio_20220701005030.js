...
const Radio = ({
  ...
  const handleChangeVolumeRain = (e) => {
    ...
    const volumeRainCheckValue =
      typeof volumeRain === "number" ? volumeRain : 50;
    if (volumeRain === 0) {
      dispatch(toggleSlice.actions.rainDayToggleHome());
    }

    dispatch(volumeSlice.actions.volumeRainAdjust(volumeRainCheckValue));
  };
          ...
          {dayRain ? (
            ...
            >
              <Slider
                ...
                onChangeCommitted={handleChangeVolumeRain}
                min={0}
                max={100}
