...
const Radio = ({
  ...
  return (
    <label className="absolute cursor-pointer w-[200px] h-[72px] group flex justify-center">
      ...
      <div
        className={`absolute top-[50%] opacity-0 p-2  text-white capitalize rounded-lg group-hover:animate-scale bg-blackBackground whitespace-nowrap group-active:block hover:text-opacity-30 transition-all duration-200 group-hover:opacity-100 text-center flex flex-col items-center`}
      >
        <p
          onClick={onClick}
