...
const Home = () => {
  ...
  console.log("🚀 ~ file: Home.js ~ line 28 ~ Home ~ cafeScene", cafeScene);
  ...
  const [cafeSceneBackGround, setSafeSceneBackGround] = useState(cafeScene);
  return (
    <HomeStyles>
      <video
        autoPlay
