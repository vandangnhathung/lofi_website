...
const Home = () => {
  ...
  const element = document.querySelector(".control-board");
  const controlBoardWidth = element.offsetWidth;
  console.log(
    "🚀 ~ file: Home.js ~ line 28 ~ Home ~ element",
    element.offsetWidth
  );
  ...
  return (
    <HomeStyles>
      ...
      <div className="absolute inset-0">
        ...
        <ControlBoard className="control-board"></ControlBoard>
      </div>
    </HomeStyles>
  );
};
