...
const Home = () => {
  ...
  console.log(
    "🚀 ~ file: Home.js ~ line 153 ~ handleCityTraffic ~ cityTrafficSound",
    cityTrafficSound
  );
  console.log(
    "🚀 ~ file: Home.js ~ line 160 ~ handleCityTraffic ~ cityTrafficDashBoard",
  ...
  const handleCityTraffic = () => {
    ...
    if (!cityTrafficSound && cityTrafficDashBoard) {
      dispatch(toggleSlice.actions.cityTrafficToggleHome(false));
    }
  };
    ...
    <>
      ...
      <HomeStyles>
        <>
          ...
          <div
            className={`${
              honoluluSceneDay ? "opacity-100" : "opacity-20"
            } transition-opacity duration-1000`}
          >
            {honoluluSceneDay && (
              <video
