...
const Toggle = () => {
  ...
  return (
    <div
      className={`h-[31px] w-[62px] p-1 rounded-full transition-all duration-400 bg-primary cursor-pointer relative flex items-center ${
        toggleButton ? "bg-transparent" : ""
      }`}
      onClick={handleToggle}
    >
      <div
        className={`day absolute left-[35px] transition-all duration-400 ${
      ...
      <div
        className={`night transition-all absolute left-[20px] duration-400 ${
