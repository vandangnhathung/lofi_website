...
const AdjustIcon = ({ mainControl }) => {
  return (
    <>
      {mainControl ? (
        <div className="absolute -scale-y-100 -top-[24px] -left-[6px] z-[999] overflow-hidden">
          <svg
            width="75"
            height="121"
            viewBox="0 0 75 121"
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="absolute w-8 h-8 transition-all duration-500 -rotate-90 -translate-x-1/2 -translate-y-1/2 rounded-full shadow-md opacity-50 hover:shadow-primary hover:opacity-100 text-primary top-1/2 left-1/2"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
