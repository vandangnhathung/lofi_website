    ...
    <>
      {openControlAdjust ? (
        <div className="absolute -scale-y-100 -top-[24px] -left-[5px] z-[999]">
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="-rotate-90 transition-opacity opacity-50 hover:opacity-100 absolute text-primary duration-500 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 h-8 w-8"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
