    ...
    >
      <div class="flex flex-col gap-y-8 overflow-hidden">
        ...
        <section className="z-50 flex flex-col gap-2 overflow-hidden">
          ...
          <aside class="flex flex-col  overflow-y-auto overflow-x-hidden no-scrollbar pt-[9px]	h-[156px]">
            <BackgroundNoise
      ...
      <button className="bg-[#111] mt-[10px] text-[#888] -ml-[32px] w-[428px] rounded-br-[24px] rounded-bl-[24px] h-[45px] hover:opacity-60 transition-all duration-200">
        Mix More
      </button>
    </ControlDashBoardStyles>
  );
