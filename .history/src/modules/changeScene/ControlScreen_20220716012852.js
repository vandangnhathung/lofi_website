...
const ControlScreen = () => {
  ...
  const honolulu = [
    {
      ...
      async onClick() {
        ...
        await dispatch(toggleSlice.actions.enterStoreToggleHome(false));
      },
    },
    {
      id: 2,
      ...
      async onClick() {
        await dispatch(changeSceneSlice.actions.handleChangeHonoluluDay(true));
        await dispatch(changeSceneSlice.actions.handleChangeCafeScene(false));
        await dispatch(toggleSlice.actions.enterStoreToggleHome(true));
      },
    },
  ];
  const cafeStore = [
  ...
  return (
    <ControlScreenStyles className="text-white">
      ...
      {cafeScene && <SwitchScene switchScene={cafeStore}></SwitchScene>}
