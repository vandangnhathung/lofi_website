...
const ControlDashBoardStyles = styled.section`
  left: calc(99% - ${(props) => props.controlBoardWidth}px - 427px);
  position: absolute;
  top: -50%;
      ...
      {mainControl && (
        <>
          ...
          <button
            ...
            className="bg-[#111] mt-[10px] text-[#888] -ml-[32px] w-[428px] rounded-br-[24px] rounded-bl-[24px] h-[45px] hover:opacity-60 transition-all duration-200"
          >
            Mix More
          </button>
        </>
      )}
      {screenControl && <div>hello</div>}
    </ControlDashBoardStyles>
  );
};
