...
export default createSlice({
  ...
  reducers: {
    volumeSummerStormAdjust: (state, action) => {
      state.volumeSummerStorm = action.payload;
    },
    volumeWindAdjust: (state, action) => {
      state.volumeWind = action.payload;
    },
    volumeWavesAdjust: (state, action) => {
      state.volumeWaves = action.payload;
    },
    volumeUnderWaterAdjust: (state, action) => {
      state.volumeUnderWater = action.payload;
    },
    volumeSnowAdjust: (state, action) => {
      state.volumeSnow = action.payload;
    },
