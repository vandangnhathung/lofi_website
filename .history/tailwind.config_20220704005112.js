  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        circulate: {
          "0%": { boxShadow: "2px 2px 25px 1px rgba(0, 0, 0, 0.8)" },
          "50%": { boxShadow: "2px 2px 14px 1px rgba(0, 0, 0, 0.4)" },
          "80%": { boxShadow: "2px 2px 25px 2px rgba(0, 0, 0, 0.2)" },
          "100%": { boxShadow: "2px 2px 35px 6px rgba(0, 0, 0, 0.6)" },
        },
      },
      animation: {
