  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        circulate: {
          "0%": { boxShadow: "0 0 3px 1px rgba(0, 0, 0, 0.8)" },
          "50%": { boxShadow: "0 0 6px 1px rgba(0, 0, 0, 0.4)" },
          "80%": { boxShadow: "0 0 10px 2px rgba(0, 0, 0, 0.2)" },
          "100%": { boxShadow: "0 0 3px 1px rgba(0, 0, 0, 1)" },
        },
      },
      animation: {
        ...
        circulate: "circulate 1s ease-in-out infinite",
      },
    },
  },
  plugins: [],
